...
Example Workflow
Initial Design: Describe the required module and functionality to the AI and request a basic Verilog implementation.
Verification Setup: Ask the AI to generate a testbench for the module and guide you through running simulations.
Iterative Refinement: Based on simulation results, request modifications and enhancements to the design from the AI.
Debugging: When errors are encountered, provide the error messages to the AI and request assistance in diagnosing and fixing the issues.
Final Integration: Once all modules are verified, ask the AI to help integrate them into the top-level design and generate the final project wrapper.
